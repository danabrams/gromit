...
func ResultToIterationLog(result *runtypes.IterationResult) *logger.IterationLog {
	...
	return &logger.IterationLog{
		...
		ReadinessStopReason:             result.ReadinessStopReason,
		...
		ComplexitySource:                result.ComplexitySource,
		ComplexityFallbackReason:        result.ComplexityFallbackReason,
		...
		TimeoutDecompositionAttemptTime: result.TimeoutDecompositionAttemptTime,
		TimeoutDecompositionOutcome:     result.TimeoutDecompositionOutcome,
		TimeoutDecompositionReason:      result.TimeoutDecompositionReason,
