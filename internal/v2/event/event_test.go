...
func TestEventJSONRoundTrip(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedFields: []string{"schema_version", "bead_id", "bead_title", "iteration", "success", "retry_attempt", "model", "provider", "cost_usd", "input_tokens", "duration"},
		},
		{
		...
		},
		{
			...
			expectedFields: []string{"schema_version", "bead_id", "model", "provider", "success", "duration", "cost_usd", "input_tokens"},
		},
		{
...
func TestEventJSONFieldNames(t *testing.T) {
	...
	events := []struct {
		...
		},
		{
			...
			expectedSnakeCase: []string{"bead_id", "bead_title", "retry_attempt", "cost_usd", "input_tokens"},
		},
		{
			name: "StageCompletedEvent",
			event: StageCompletedEvent{
		...
		},
		{
			...
			expectedSnakeCase: []string{"bead_id", "cost_usd", "input_tokens"},
		},
		{
			name: "ModelSelectedEvent",
			event: ModelSelectedEvent{
