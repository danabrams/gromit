...
func (c *capturingTrackerClient) Show(ctx context.Context, id string) (*BeadInfo, error) {
	return nil, nil
}
...
func (c *capturingTrackerClient) ListWithLabel(ctx context.Context, label string) ([]string, error) {
	return []string{}, nil
}
...
func (c *failingTrackerClient) Show(ctx context.Context, id string) (*BeadInfo, error) {
	return nil, nil
}
...
func (c *failingTrackerClient) ListWithLabel(ctx context.Context, label string) ([]string, error) {
	return []string{}, nil
}
