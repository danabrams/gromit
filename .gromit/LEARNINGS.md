...
Disk space issues in /tmp can block Go builds and tests. Use the Claude-provided scratchpad directory instead of /tmp for temporary build artifacts and test files to avoid conflicts with system temp space constraints.
