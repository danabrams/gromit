...
*Archived 2026-02-21: Generic debugging advice — 'check both logs and state file' is universal practice. The clean_exit=false correlation is thin and doesn't reference specific functions or patterns unique to gromit beyond the state.json field name.*
...
*Archived 2026-02-21: Consolidated into "Architectural Invariant Enforcement Pattern" entry with compile-time interface check learning.*
...
*Archived 2026-02-21: Consolidated into "Architectural Invariant Enforcement Pattern" entry.*
...
*Archived 2026-02-21: Promoted to RULES.md Architecture section — rule strengthened to explicitly cover test files.*
...
*Archived 2026-02-21: Generic engineering advice — 'pair fail-open with diagnostic signal' is universal resilience pattern. The specific learnings.File.Add behavior is implementation detail visible in the code.*
