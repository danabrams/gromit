# Task Execution — Test-Driven Development
...
- Before completing, run `go test` and `go vet` scoped to touched packages (e.g., `go test ./internal/foo/...`), not `./...`. Fix any failures before committing.
